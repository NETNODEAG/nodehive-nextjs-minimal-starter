...
import { buttonVariants } from '@/components/theme/atoms-content/button/button';
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected: cn(
          props.mode === 'range'
            ? 'bg-eco-primary-orange hover:bg-eco-primary-orange hover:text-black focus:bg-eco-primary-orange focus:text-black'
            : '[&>button]:bg-eco-primary-orange [&>button]:text-black !rounded-md [&>button]:hover:bg-eco-primary-orange [&>button]:hover:text-black'
        ),
